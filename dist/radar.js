...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__select__ = __webpack_require__(162);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__selectAll__ = __webpack_require__(163);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__filter__ = __webpack_require__(151);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__exit__ = __webpack_require__(150);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__merge__ = __webpack_require__(155);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__order__ = __webpack_require__(158);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__sort__ = __webpack_require__(165);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__node__ = __webpack_require__(156);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__size__ = __webpack_require__(164);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__empty__ = __webpack_require__(149);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__property__ = __webpack_require__(159);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__html__ = __webpack_require__(152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__raise__ = __webpack_require__(160);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__lower__ = __webpack_require__(154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__append__ = __webpack_require__(141);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__insert__ = __webpack_require__(153);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__remove__ = __webpack_require__(161);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__datum__ = __webpack_require__(146);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__on__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__dispatch__ = __webpack_require__(147);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_deviation__ = __webpack_require__(37);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__src_threshold_freedmanDiaconis__ = __webpack_require__(87);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__src_threshold_scott__ = __webpack_require__(88);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_max__ = __webpack_require__(79);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_mean__ = __webpack_require__(80);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_median__ = __webpack_require__(81);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__src_merge__ = __webpack_require__(82);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__src_min__ = __webpack_require__(39);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__src_permute__ = __webpack_require__(83);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__src_range__ = __webpack_require__(41);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__src_scan__ = __webpack_require__(84);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__src_shuffle__ = __webpack_require__(85);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__src_sum__ = __webpack_require__(86);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__tickFormat__ = __webpack_require__(132);
...
exports.scales = exports.diameter = exports.dimensions = exports.axes = undefined;

var _d3Scale = __webpack_require__(117);

// Axial

var axes = exports.axes = function axes(_ref) {
    var metrics = _ref.metrics;

    var global = metrics.map(function (m) {
        var local = m.range.map(function (m) {
            return m.value;
        });
    ...
    return {
        ...
        names: metrics.map(function (m) {
            return m.name;
        }),
        range: {
            min: Math.min.apply(null, global.map(function (v) {
                return v.min;
            })) - 1,
            max: Math.max.apply(null, global.map(function (v) {
                return v.max;
            })) + 1
        }
    };
...
var dimensions = exports.dimensions = function dimensions(data) {
    return {
        radius: 300
    };
};
...
var diameter = exports.diameter = function diameter(index, radius, range) {
    return radius - index * (radius / (range.max - range.min));
};

// Scalar

var scales = exports.scales = function scales(axes, dimensions) {
    return {
        scale: (0, _d3Scale.scaleLinear)().range([0, dimensions.radius]).domain([axes.range.min, axes.range.max])
    };
};
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__min__ = __webpack_require__(39);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_defaultLocale__ = __webpack_require__(98);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_formatSpecifier__ = __webpack_require__(49);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_precisionFixed__ = __webpack_require__(104);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_precisionPrefix__ = __webpack_require__(105);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_precisionRound__ = __webpack_require__(106);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__formatTypes__ = __webpack_require__(50);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__formatDefault__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__formatPrefixAuto__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__formatRounded__ = __webpack_require__(102);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__formatSpecifier__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__formatTypes__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__formatPrefixAuto__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__identity__ = __webpack_require__(103);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__sparse__ = __webpack_require__(65);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_isoParse__ = __webpack_require__(169);
...
var _d3Selection = __webpack_require__(135);

// Graphics

var graphics = exports.graphics = function graphics(dimensions, id) {
      var graphics = (0, _d3Selection.select)(id).append('svg').attr('width', 700).attr('height', 700).append('g').attr('transform', 'translate(350, 350)');
...
var _calculations = __webpack_require__(33);
...
var axial = function axial(axes, base, dimensions, scales) {

    // Axial lines radiating from the radar centre point, scaled for the common
    // d3 scale in use.

    var lines = function lines(axes, common, dimensions, scale) {
        return common.append('line').attr('x1', 0).attr('y1', 0).attr('x2', function (_, i) {
            return scale(axes.range.max) * Math.cos(axes.arc * i - Math.PI / 2);
        }).attr('y2', function (_, i) {
            return scale(axes.range.max) * Math.sin(axes.arc * i - Math.PI / 2);
        }).attr('class', 'line').style('stroke', '#fff').style('stroke-width', '1px');
    };
    ...
    var common = function common(axes, base) {
        return base.selectAll('.axial-lines').data(axes.names).enter().append('g');
    };

    // Common base d3 elements (instance).

    var common_ = common(axes, base);
...
var radial = function radial(axes, base, dimensions) {

    var circles = function circles(axes, base, dimensions) {
        return base.selectAll('.radials').data((0, _d3Array.range)(axes.range.min, axes.range.max).reverse()).enter().append('circle').attr('r', function (_, i) {
            return (0, _calculations.diameter)(i, dimensions.radius, axes.range);
        }).style('fill', '#ccc').style('fill-opacity', 0.25).style('stroke', '#fff');
    };

    var labels = function labels(axes, base, dimensions) {
        return base.selectAll('.radial-labels').data((0, _d3Array.range)(axes.range.min, axes.range.max).reverse()).enter().append('text').attr('x', 5).attr('y', function (_, i) {
            return -1 * (0, _calculations.diameter)(i, dimensions.radius, axes.range);
        }).attr('dy', "0.4em").style('fill', '#999').style('font-family', 'sans-serif').style('font-size', "11px").text(function (d) {
            return d;
        });
    };
...
var grid = exports.grid = function grid(axes, dimensions, graphics, scales) {

    var base = function base(graphics) {
        return graphics.append('g').attr('class', 'base');
    };

    var _base = base(graphics);
    var _radial = radial(axes, _base, dimensions);
    var _axials = axial(axes, _base, dimensions, scales);
...
var show = exports.show = function show(id, data) {

    // Calculations

    var _axes = (0, _calculations.axes)(data);
    var _dimensions = (0, _calculations.dimensions)(data);
    var _scales = (0, _calculations.scales)(_axes, _dimensions);

    // Graphics

    var _graphics = (0, _core.graphics)(_dimensions, id);
    var _grid = (0, _grid2.grid)(_axes, _dimensions, _graphics, _scales);
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__range__ = __webpack_require__(41);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__deviation__ = __webpack_require__(37);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_nest__ = __webpack_require__(93);
/* unused harmony reexport nest */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_set__ = __webpack_require__(94);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_keys__ = __webpack_require__(92);
/* unused harmony reexport keys */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_values__ = __webpack_require__(95);
/* unused harmony reexport values */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_entries__ = __webpack_require__(91);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_band__ = __webpack_require__(118);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_identity__ = __webpack_require__(124);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_log__ = __webpack_require__(125);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_pow__ = __webpack_require__(126);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_quantile__ = __webpack_require__(127);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_quantize__ = __webpack_require__(128);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__src_threshold__ = __webpack_require__(131);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__src_utcTime__ = __webpack_require__(133);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_category10__ = __webpack_require__(119);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_category20b__ = __webpack_require__(121);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_category20c__ = __webpack_require__(122);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__src_category20__ = __webpack_require__(120);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__src_rainbow__ = __webpack_require__(129);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__src_viridis__ = __webpack_require__(134);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__src_sequential__ = __webpack_require__(130);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3_array__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_d3_format__ = __webpack_require__(47);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_matcher__ = __webpack_require__(63);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_selectAll__ = __webpack_require__(140);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_selection_style__ = __webpack_require__(66);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_touch__ = __webpack_require__(167);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_touches__ = __webpack_require__(168);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__enter__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__constant__ = __webpack_require__(136);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__index__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__matcher__ = __webpack_require__(63);
